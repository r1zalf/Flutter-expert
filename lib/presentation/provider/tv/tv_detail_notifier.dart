...
class TvSeriesDetailNotifier extends ChangeNotifier {
  ...
  final GetWatchTvListStatus getWatchListStatus;
  final SaveWatchTvlist saveWatchlist;
  final RemoveWatchTvlist removeWatchlist;
      ...
      (tvSeries) {
        ...
        recommendationResult.fold(
          ...
          (tvSeriesRecomm) {
            ...
            _tvSeriesRecommendations = tvSeriesRecomm;
          },
        );
